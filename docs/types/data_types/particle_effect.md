...
!!! note
    ...
    Refer to the [Minecraft Wiki: Particles (Java Edition) (Types of particles)](https://minecraft.wiki/w/Particles_(Java_Edition)#Types_of_particles) page for a list of **vanilla** particle type IDs that you can use.
