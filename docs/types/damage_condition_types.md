...
* [Bypasses Armor **(DEPRECATED)**](damage_condition_types/bypasses_armor.md)
* [Explosive **(DEPRECATED)**](damage_condition_types/explosive.md)
* [Fire **(DEPRECATED)**](damage_condition_types/fire.md)
* [From Falling **(DEPRECATED)**](damage_condition_types/from_falling.md)
