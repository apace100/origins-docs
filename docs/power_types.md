...
* [Entity Glow](entity_glow)
* [Entity Group](entity_group)
* [Exhaust](exhaust)
* [Fire Immunity](fire_immunity)
* [Fire Projectile](fire_projectile)
* [Ignore Water](ignore_water)
* [Inventory](inventory)
* [Invisibility](invisibility)
* [Invulnerability](invulnerability)
* [Launch](launch)
* [Lava Vision](lava_vision)
...
* [Recipe](recipe)
* [Resource](resource)
* [Restrict Armor](restrict_armor)
* [Shader](shader)
* [Shaking](shaking)
* [Simple](simple)
* [Stacking Status Effect](stacking_status_effect)
* [Starting Equipment](starting_equipment)
* [Swimming](swimming)
* [Toggle Night Vision](toggle_night_vision)
* [Toggle](toggle)
* [Walk On Fluid](walk_on_fluid)
...
* [Modify Projectile Damage](modify_projectile_damage)
